...
<HTML>
<%
	XIBBVBBtoCCTop[] list = XIBBVBBtoCCTopAcc.getByStatus("90");
%>
<HEAD>
	<TITLE>送信済一覧【xi1650】</TITLE>
	<LINK rel="stylesheet" href="../css/style01.css" type="text/css" />
	<SCRIPT type="text/javascript" src="../js/xi1650.js"></SCRIPT>
</HEAD>
<BODY>
<DIV align="center">
	<TABLE width="960">
		<TR>
			<TD align="center"><P class="title01">送信済一覧</P></TD>
		</TR>
		<TR>
			<TD align="right">
				<A href="./submenu1.jsp">
