...
<%
	...
	String base = "チェックパターン IN ( 'J' , 'K' , 'L' )";
	XIBBSeikyuusaki[] seiklist = XIBBSeikyuusakiAcc.getByKeyword( base , kwd1 , kwd2 , kwd3 );
%>
<HEAD>
	<TITLE>パターン一覧【xi1410】</TITLE>
	<LINK rel="stylesheet" href="../css/style01.css" type="text/css" />
	<SCRIPT type="text/javascript" src="../js/xi1410.js"></SCRIPT>
</HEAD>
<BODY>
<DIV align="center">
	<TABLE width="1024">
		<TR>
			<TD align="center"><P class="title01">パターン一覧(明細登録用)</P></TD>
		</TR>
		<TR>
			<TD align="right">
				<A href="./submenu1.jsp">
	...
	<FORM name="kensaku01" method="post" action="./xi1410.jsp" >
	...
	<TABLE width="1024">
		...
		<TR>
			<TD>
				<P class="text01">
					件名未登録エラーの対応は「新規追加」から。<BR/>
					「起票者(メールアドレス)」の変更は編集ボタンから、「工事コード」「部門コード」の登録は、明細ボタンから。
				</P>
			</TD>
		</TR>
		<TR>
...
%>
		<TR height="60" class="<%=row_cls %>">
			<TD align="center">
				<A href="./xi1420.jsp?no=<%=no %>&kwd1=<%=e_kwd1 %>&kwd2=<%=e_kwd2 %>&kwd3=<%=e_kwd3 %>" >
					<%=no %>
				</A>
			</TD>
			...
			<TD align="center">
				<A href="./xi1510.jsp?no=<%=no %>&ptn=<%=ptn %>&kwd1=<%=e_kwd1 %>&kwd2=<%=e_kwd2 %>&kwd3=<%=e_kwd3 %>">
					<IMG src="../image/meisai01.png" onmouseover="this.src='../image/meisai02.png'"
						 onmouseout="this.src='../image/meisai01.png'" class="img" />
				</A>
			</TD>
			<TD align="center">
				<A href="./xi1460.jsp?no=<%=no %>&kwd1=<%=e_kwd1 %>&kwd2=<%=e_kwd2 %>&kwd3=<%=e_kwd3 %>">
