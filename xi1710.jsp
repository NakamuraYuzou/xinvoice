...
%>
<HEAD>
	<TITLE>パターン一覧【xi1710】</TITLE>
	<LINK rel="stylesheet" href="../css/style01.css" type="text/css" />
	<SCRIPT type="text/javascript" src="../js/xi1710.js"></SCRIPT>
</HEAD>
<BODY>
<DIV align="center">
	<TABLE width="1024">
	...
	<TABLE width="1024">
		...
		<TR>
			<TD>
				<P class="text01">
					「起票者(メールアドレス)」や「工事コード」の変更は編集ボタンから。
				</P>
			</TD>
		</TR>
	</TABLE>
...
%>
		<TR height="60" class="<%=row_cls %>">
			<TD align="center">
				<A href="./xi1720.jsp?no=<%=no %>&kwd1=<%=e_kwd1 %>&kwd2=<%=e_kwd2 %>&kwd3=<%=e_kwd3 %>" >
					<%=no %>
				</A>
			</TD>
			...
			<TD align="center">
				<A href="./xi1730.jsp?no=<%=no %>&kwd1=<%=e_kwd1 %>&kwd2=<%=e_kwd2 %>&kwd3=<%=e_kwd3 %>">
