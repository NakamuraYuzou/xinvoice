...
<DIV align="center">
	<TABLE width="1024">
		<TR>
			<TD align="center"><P class="title01">未登録件名(明細単位の登録用)</P></TD>
		</TR>
		<TR>
			<TD align="right">
				<A href="./xi1410.jsp?kwd1=<%=e_kwd1 %>&kwd2=<%=e_kwd2 %>&kwd3=<%=e_kwd3 %>">
...
%>
		<TR height="60" class="<%=row_cls %>">
			...
			<TD align="center">
				<A href="./xi1440.jsp?code=<%=code %>&moto=<%=e_clm1 %>&saki=<%=e_clm2 %>&kenmei=<%=e_clm3 %>&kwd1=<%=e_kwd1 %>&kwd2=<%=e_kwd2 %>&kwd3=<%=e_kwd3 %>">
