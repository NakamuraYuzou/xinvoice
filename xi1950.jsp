...
<%
	...
	String toricd = request.getParameter("toricode");
...
%>
<HEAD>
	<TITLE>明細パターン登録【xi1950】</TITLE>
	<LINK rel="stylesheet" href="../css/style01.css" type="text/css" />
	<SCRIPT type="text/javascript" src="../js/xi1950.js"></SCRIPT>
</HEAD>
<BODY>
<DIV align="center">
	<TABLE width="800>
	...
	<FORM name="touroku01"  action="xi1960.jsp" method="post" >
	<TABLE width="800"  class="tbl01">
		<TR height="80">
			<TD class="header01" width="30%">相手先コード</TD>
			<TD class="row01" width="70%">
				&nbsp;<INPUT name="toricode" type="text" size="6" value="<%=toricd %>" readonly class="input01"/>
			</TD>
		</TR>
		<TR height="80">
